...
namespace inspineaMVC
{
    public class BundleConfig
    {
        ...
        {
            //css de botones para datatable
            bundles.Add(new StyleBundle("~/Content/tabla").Include(
                      "~/Content/btnTabla.css"));
            ...
            //scrips generales para las vistas 
            bundles.Add(new ScriptBundle("~/general/Compuesta").Include(
                        "~/scripts/app/general/Compuesta.js",
                        "~/scripts/app/general/table.min.js"));
            bundles.Add(new ScriptBundle("~/general/Simple").Include(
                        "~/scripts/app/general/table.min.js"));
            bundles.Add(new ScriptBundle("~/general/Modals").Include(
                        "~/scripts/app/general/Modals.js"));

            //scrips personalizados 
            bundles.Add(new ScriptBundle("~/view/FaseSeleccion").Include(
                       "~/scripts/app/view/FaseSeleccion.js"));
            bundles.Add(new ScriptBundle("~/view/Seleccion").Include(
                       "~/scripts/app/view/Seleccion.js"));
